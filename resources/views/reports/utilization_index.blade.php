			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
				        ...
				        @endif
						<div class="pull-left">
							<h3 class="page-header"><i class="fa fa-file-o"></i><strong>{{ $data['page'] }} || UTILIZATION</strong> 
						</div>
					</div>
				</div>
				{!! Form::open(['url' => 'report/utilization/download', 'class' => 'form-horizontal', 'role' => 'form', 'autocomplete' => 'off', 'target'=>'_blank']) !!}
				<div class="panel panel-default panel-plain">
					...
					<div class="panel-body">
						<div class="row">
							...
							<div class="form-group">
								<label class="col-md-2 control-label">Select Report Utilization</label>
								<div class="col-md-8">							
									{!! Form::select('reportUtilization', [	
									   	'Outgoing' 	=> 'Outgoing Utilization',
									   	'Event'  	=> 'Event Utilization',
									   	'User'		=> 'User Logs'],
