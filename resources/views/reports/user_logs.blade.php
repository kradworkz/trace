			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
				        ...
				        @endif
						<div class="pull-left">
							<h3 class="page-header"><i class="fa fa-file-o"></i><strong>{{ $data['page'] }} || USER LOGS</strong> 
						</div>
					</div>
				</div>
				{!! Form::open(['url' => 'report/userlogs/download', 'class' => 'form-horizontal', 'role' => 'form', 'autocomplete' => 'off', 'target'=>'_blank']) !!}
				<div class="panel panel-default panel-plain">
					<div class="panel-heading">
						<h1 class="panel-title"><strong>Report Parameters</strong></h1>
					</div>
					<?php
						$start_date = App\Models\UserLog::orderBy('created_at', 'asc')->value('created_at');
						$end_date 	= App\Models\UserLog::orderBy('created_at', 'desc')->value('created_at');
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="pull-right">
								...
								<a href="{{ url('report/userlogs') }}" class="btn btn-danger btn-sm"><span class="fa fa-ban"></span> Reset</a>
							</div>
						</div>
					</div>
				</div>
